...
and the verification method described in~\cite{ahrendt2020functional} and verified in \cite{marmsoler2023}.

The version of Isabelle/Solidity described in this paper is available online \fxfatal{Add link}.
\autoref{fig:approach} shows its architecture.
\begin{figure}[t]
    \centering
    \begin{tikzpicture}[%
