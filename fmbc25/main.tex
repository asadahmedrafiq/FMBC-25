...
%
To formally verify the invariant, Isabelle/Solidity allows to specify the verification of invariants using \texttt{verificaiton} command. 
%
It accepts the name of the invariant, postcondition on constructor and methods to generate proof obligations. 
%
