...
\begin{description}
    ...
    \item[WP calculus]
    To support a user in the verification of Solidity programms, Isabelle/Solidity comes with a verification condition generator (VCG).
...
\begin{description}
    ...
    It requires a them to specify a list of member variables, a constructor, and a list of methods.
...
The verification command tries to proof a general correctness theorem for our contract.
